      ...
      <el-row class="e_common orderDeatail_content">
        <el-collapse v-model="activeNames">
          <el-collapse-item title="主要信息" name="1">
            <el-row>
              <el-col :span="1" class="col_span">  <label>客户编号</label></el-col><el-col :span="4">  <el-input :readonly = "readOnly" v-model="customer.code">  </el-input></el-col>
              <el-col :span="1" class="col_span">  <label>客户简称</label></el-col><el-col :span="4">  <el-input  :readonly = "readOnly"  v-model="customer.shortName"/></el-col>
              <el-col :span="1" class="col_span">  <label>客户名称</label></el-col><el-col :span="4">  <el-input :readonly = "readOnly" v-model="customer.name">  </el-input></el-col>
              <el-col :span="1" class="col_span">  <label>区域</label></el-col><el-col :span="4">  <el-input :readonly = "readOnly" v-model="customer.county">  </el-input></el-col>
            </el-row>
            <el-row>
              <el-col :span="1" class="col_span">  <label>省份</label></el-col><el-col :span="4">  <el-input :readonly = "readOnly" v-model="customer.province">  </el-input></el-col>
              <el-col :span="1" class="col_span">  <label>城市</label></el-col><el-col :span="4">  <el-input  :readonly = "readOnly"  v-model="customer.city"/></el-col>
              <el-col :span="1" class="col_span">  <label>网址</label></el-col><el-col :span="4">  <el-input :readonly = "readOnly" v-model="customer.website">  </el-input></el-col>
              <el-col :span="1" class="col_span">  <label>邮编</label></el-col><el-col :span="4">  <el-input :readonly = "readOnly" v-model="customer.postCode">  </el-input></el-col>
            </el-row>
            <el-row>
              <el-col :span="1" class="col_span">  <label>地址</label></el-col><el-col :span="4">  <el-input :readonly = "readOnly" v-model="customer.address">  </el-input></el-col>
              <el-col :span="1" class="col_span">  <label>客户来源</label></el-col><el-col :span="4">  <el-input :readonly = "readOnly" v-model="customer.source">  </el-input></el-col>
              <el-col :span="1" class="col_span">  <label>合作等级</label></el-col><el-col :span="4">  <el-input :readonly = "readOnly"  v-model="customer.corporateLevel">  </el-input></el-col>
              <el-col :span="1" class="col_span">  <label>业务员</label></el-col><el-col :span="4">  <el-input :readonly = "readOnly" v-model="customer.salesman">  </el-input></el-col>
            </el-row>
            <el-row>
              <el-col :span="1" class="col_span">  <label>付款方式</label></el-col><el-col :span="4">  <el-input  :readonly = "readOnly"  v-model="customer.paymentWay"/></el-col>
              <el-col :span="1" class="col_span">  <label>经营业务</label></el-col><el-col :span="4">  <el-input :readonly = "readOnly" v-model="customer.business">  </el-input></el-col>
              <el-col :span="1" class="col_span">  <label>建档时间</label></el-col><el-col :span="4">  <el-date-picker :readonly = "readOnly"  v-model="customer.createDate" type="date"/></el-col>
            </el-row>
            <el-row>
              <el-col :span="1" class="col_span"><label>开票信息</label></el-col><el-col :span="22"><el-input type="textarea" :rows="2" :readonly = "readOnly" v-model="customer.ticketInfo">  </el-input></el-col>
            </el-row>
          </el-collapse-item>
          <el-collapse-item title="联系人信息" name="3">
            ...
            <el-table :data="customer.orderProductList" border style="width: 100%" ref="productTable"
          ...
          <el-collapse-item title="联系日志" name="4">
            <div class="div_product">
            ...
            <el-table :data="customer.orderChargeList" border style="width: 100%" @select="tableSelectCharge" :row-class-name="tableRowClassName">
              <el-table-column fixed type="selection" width="35"></el-table-column>
              <el-table-column prop="chargeName" label="业务员" width="120"></el-table-column>
              <el-table-column prop="chargeMoney" label="联系时间" width="120"></el-table-column>
              <el-table-column prop="description" label="联系方式" width="120"> </el-table-column>
              <el-table-column prop="description" label="联系人" width="120"> </el-table-column>
              <el-table-column prop="description" label="联系内容" width="120"> </el-table-column>
              <el-table-column prop="description" label="后续安排事项" width="120"> </el-table-column>
              <el-table-column prop="description" label="备注"> </el-table-column>
            </el-table>
          </el-collapse-item>
          <el-collapse-item title="备注" name="5">
            <el-row class="total_el">
              <el-input type="textarea" :rows="2" :readonly = "readOnly" v-model="customer.description">  </el-input>
            </el-row>
          </el-collapse-item>
        </el-collapse>
      </el-row>
      ...
      <el-dialog
        ...
        <el-row class="row_pro_content">
          <el-form ref="form" :model="form">
            ...
            <el-row class="row_product">
              <el-col :span="2"><span>业务员</span> </el-col> <el-col :span="5"><el-input v-model="orderCharge.chargeName"></el-input></el-col>
              <el-col :span="3"><span>联系时间</span> </el-col> <el-col :span="5"><el-input v-model="orderCharge.chargeMoney"></el-input> </el-col>
              <el-col :span="3"><span>联系方式</span> </el-col> <el-col :span="5"><el-input v-model="orderCharge.description"></el-input> </el-col>
            </el-row>
            <el-row class="row_product">
              <el-col :span="2"><span>联系人</span> </el-col> <el-col :span="5"><el-input v-model="orderCharge.chargeName"></el-input></el-col>
              <el-col :span="3"><span>联系内容</span> </el-col> <el-col :span="5"><el-input v-model="orderCharge.chargeMoney"></el-input> </el-col>
              <el-col :span="3"><span>后续安排事项</span> </el-col> <el-col :span="5"><el-input v-model="orderCharge.description"></el-input> </el-col>
            </el-row>
            <el-row class="row_product">
              <el-col :span="2"><span>备注</span> </el-col> <el-col :span="5"><el-input v-model="orderCharge.chargeName"></el-input></el-col>
            </el-row>
            <el-row style="text-align: right;">
...
<script>
  import {queryCustomerDetail}  from '@/api/modules/customer'
  ...
  export default {
    ...
    created:function () {
      ...
      // 详情查询
      if(customerCode){
        queryCustomerDetail(customerCode).then(res=>{
          this.customer = res;
          // 为每条产品信息复制index下标，方便后期操作
          if(this.customer.orderProductList){
            for(var i =0 ;i< this.customer.orderProductList.length;i++){
              this.customer.orderProductList[i].index = i;
            }
          }
          // 为每条订单费用信息复制Index下标，方便后期操作
          if(this.customer.orderChargeList){
            for(var i =0 ;i<this.customer.orderChargeList.length;i++){
              this.customer.orderChargeList[i].index = i;
            }
          }
        })
      }
    ...
    methods:{
      ...
      // 新增销售订单产品信息（打开模态框）
      addProduct:function(){
        this.orderProduct.orderNumber = this.customer.orderNumber;
      ...
      saveProduct:function(){
        ...
        if(this.orderProduct.index == '' || this.orderProduct.index == undefined){
          this.customer.orderProductList.push(this.orderProduct);
        }
        // 有ID一般为修改
        else{
          this.customer.orderProductList.index = this.customer.orderProductList.length;
          this.customer.orderProductList.splice(this.orderProduct.index,1);
          this.customer.orderProductList.splice(this.orderProduct.index,0,JSON.parse(JSON.stringify(this.orderProduct)));
        }
        this.orderProduct = {};
          ...
          this.$confirm('此删除操作将即时生效, 是否继续?', '提示', {
            ...
            for(var i = this.checkedRowsProduct.length -1 ; i>= 0;i--){
              ...
              if(this.checkedRowsProduct[i].index >= 0){
                this.customer.orderProductList.splice(this.checkedRowsProduct[i].index,1);
              }
            }
      ...
      // 新增销售订单费用信息（打开模态框）
      addCharge:function(){
        this.orderCharge.orderNumber = this.customer.orderNumber;
      ...
      saveCharge:function(){
        ...
        if(this.orderCharge.index == '' || this.orderCharge.index == undefined){
          this.orderCharge.index = this.customer.orderChargeList.length;
          this.customer.orderChargeList.push(this.orderCharge);
        }
        // 有index一般为修改
        else{
          this.customer.orderChargeList.splice(this.orderCharge.index,1);
          this.customer.orderChargeList.splice(this.orderCharge.index,0,JSON.parse(JSON.stringify(this.orderCharge)));
        }
        this.orderCharge = {};
          ...
          this.$confirm('此删除操作将即时生效, 是否继续?', '提示', {
            ...
            for(var i = this.checkedRowsCharge.length -1 ; i>= 0;i--){
              ...
              if(this.checkedRowsCharge[i].index >= 0){
                this.customer.orderChargeList.splice(this.checkedRowsCharge[i].index,1);
              }
            }
      ...
      // 保存订单产品信息
      saveOrder:function(){
        saveOrder(this.customer).then(res=>{
          if(res.status == 0){
            this.$message({
              showClose: true,
              message: '保存成功~',
